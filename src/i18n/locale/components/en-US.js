export default {
    ...
    components: {
        table: {
            layout1: 'Saved Layout',
            layout2: 'New Layout',
            info: 'Tip: The layout is stored on the client. You need to reset it after clearing the cache!',
            info2: 'Lines per page',
            info3: 'Freeze the first columns',
            info4: 'Select Display',
            info5: 'Are you sure to delete?',
            info6: 'Please enter a layout name',
            info7: 'Duplicate layout name',
            save: 'Save',
        ...
        menuTree: {
            ...
            projectPeriod: 'Project Cycle',
            to: 'to',
            noResults: 'There are currently no relevant query results'
        },
        empty: {
            description: 'No Data'
        }
