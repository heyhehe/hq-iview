export default {
    ...
    components: {
        table: {
            layout1: 'Gespeichertes Layout',
            layout2: 'Neues Layout',
            info: 'Tipp: Das Layout wird auf dem Client gespeichert und muss nach dem Löschen des Cache zurückgesetzt werden!',
            info2: 'Zeilen pro Seite',
            info3: 'Erste Spalten einfrieren',
            info4: 'Angezeigt',
            info5: 'Sind Sie sicher, dass Sie löschen?',
            info6: 'Layoutname',
            info7: 'Name des Layouts duplizieren',
            save: 'Save',
        ...
        menuTree: {
            customFilter: 'Benutzerdefinierte Abfrage',
            expandCollapse: 'Zusammenklappen erweitern',
            collapse: 'Falten',
            expand: 'offen',
            fold: 'Pack zusammen',
            noMore: 'Nicht mehr',
            ...
            projectPeriod: 'Projektzyklus',
            to: 'zu',
            noResults: 'Derzeit liegen keine relevanten Abfrageergebnisse vor'
        },
        empty: {
    ...
    vxe: {
        ...
        error: {
            groupFixed:
                'If you use group headers, the fixed columns must be set by group.',
            groupMouseRange:
                'Grouping headers and "{0}" cannot be used at the same time, which may cause errors.',
            groupTag:
                'Grouping column header should use "{0}" instead of "{1}", which may cause errors.',
            scrollErrProp:
                'The parameter "{0}" is not supported when virtual scrolling is enabled.',
            ...
            expandContent:
                'Expand row slot should be "content", please check if it is correct.',
            reqModule: 'require "{0}" module.',
            reqProp:
                'Missing the necessary "{0}" parameter, which can cause error.',
            emptyProp: 'The property "{0}" is not allowed to be empty.',
            errProp: 'Unsupported parameter "{0}", possibly "{1}".',
            colRepet:
                'column.{0}="{0}" is duplicated, which may make some features unusable',
            ...
            coverProp:
                'The parameter "{1}" to "{0}" is overwritten. This may cause an error',
            ...
            removeProp:
                'The property "{0}" is deprecated and is not recommended, which may cause error.',
            errFormat:
            ...
            impFields:
                'Import failed, please check that the field name and data format are correct.',
        ...
        pro: {
            area: {
                ...
                multiErr:
                    'The operation cannot be performed on multiple selection areas',
                extendErr:
        ...
        pager: {
            goto: 'Gehe zu',
            pagesize: '{0}/seite',
            total: 'Total {0} Einträge',
            pageClassifier: '',
            prevPage: 'Vorherige Seite',
            nextPage: 'Nächste Seite',
            prevJump: 'Vorherige Seite springen',
            nextJump: 'Nächste Seite springen'
        },
        alert: {
        ...
        export: {
            ...
            expColgroupTitle:
                'If it exists, headers with grouping structure are supported',
            expOptMerge: 'Merge',
            expMergeTitle:
                'If it exists, cells with merged structures are supported',
            expOptAllExpand: 'Expand nodes',
            expAllExpandTitle:
                'If it exists, all data with tree structure can be expanded',
            expOptUseStyle: 'Styles',
            expUseStyleTitle: 'If it exists, cells with styles are supported',
            expOptOriginal: 'Source data',
            expOriginalTitle:
                'If it is source data, import into the table is supported',
            expPrint: 'Print',
            expConfirm: 'Export',
            expCancel: 'Cancel'
        },
